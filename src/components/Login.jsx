...
const Login = () => {
    ...
    return (
        <div name='Login' className='w-full h-screen bg-[#0C4346]'>
            {/* Container */}
                        ...
                        >
                            ...
                            <div class="xl:ml-20 xl:w-5/12 lg:w-5/12 md:w-8/12 mb-12 md:mb-0">
                                <form>
                                    ...
                                    <div
                                        class=" bg-[#AD9128] flex items-center my-4 before:flex-1 before:border-t before:border-gray-300 before:mt-0.5 after:flex-1 after:border-t after:border-gray-300 after:mt-0.5"
                                    >
